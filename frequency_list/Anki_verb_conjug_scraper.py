...
def get_page(page_id):
    '''
    Wiktionary words have unique page IDs that identify all words.
    This uses the page ID to scrape all contents from said page.
    '''
...
def get_verb(doc):
    '''
    Here the verb is found from the wikitionary html.
    It carries out a series of checks to make sure all relevant 
    and desired data is scraped. Further expansion of this code requires
    changes in which classes in the data are scraped, e.g. which
    conjugations are needed.
    '''
